...
//                .enterInvalidCardNumber(crCard, true);
        ...
        String cardMsg = CardInfo_pg.init(t1)
                .errorMsgInvalidCard();
        Thread.sleep(2000);
        Assertion.verifyContains(cardMsg, MessageReader.getMessage("error.msg.for.invalid.card",null),"invalid card",t1);
//        Thread.sleep(2000);
//        CardInfo_pg.init(t1)
//                .okBtn();
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        Assertion.verifyContains(expMsg, MessageReader.getMessage("error.msg.for.invalid.exp.date",null),"invalid expiry date",t1);
        CardInfo_pg.init(t1)
                .okBtn();
        Thread.sleep(2000);
        ...
        Assertion.verifyContains(msg, MessageReader.getMessage("error.msg.for.empty.fields.LB",null),"error message for invalid details",t1);
    }
}
