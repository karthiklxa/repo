 ...
 */
public class ToVerifyPushMSGSentAfterSubmittingMSISDNNumber extends TestInit
{


    @Test(priority = 1)
    public void verifyPushMSGSent() throws Exception {
        ExtentTest t1 = pNode.createNode("PAYPLUS-673-push-03", "To Verify Push MSG Received After Submitting MSISDN Number");
