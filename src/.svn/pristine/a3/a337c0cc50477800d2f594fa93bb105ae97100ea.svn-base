 ...
 */
public class ToVerifyTheCurrencySymbolNearTransactionAmountInWallet extends TestInit {
    @Test
    public void toVerifySymbolNearAmount() throws Exception {
        ExtentTest t1 = pNode.createNode("PAYPLUS-1581-WA-Card-03", "To Verify The Currency Symbol Near Transaction Amount");
