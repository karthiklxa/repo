 ...
 */
public class ToVerifyTheHeaderContainsAmtAndCurInWallet extends TestInit {
    @Test
    public void toVerifyAmountAndCurrencyInHeader() throws Exception {
        ExtentTest t1 = pNode.createNode("PAYPLUS-1581-WA-Card-05", "To Verify The Header Contains Amount And Curency");
