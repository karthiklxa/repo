...
//    @FindBy(id = "paymentInstrumentIcon2")
    ...
    @FindBy(xpath = "//h3[contains(text(),'Please Check with Money Provider for Refund.')]")
    private WebElement RefundMsg;
    ...
    public WalletInfo_pg enterMobNumMP(String mobNum) throws InterruptedException {
        Thread.sleep(2000);
    ...
    public String refundMsg(){
        return wait.until(ExpectedConditions.visibilityOf(RefundMsg)).getText();
    }
