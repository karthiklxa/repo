...
public class SystemAdminCreation_pg extends PageInit {
    ...
    @FindBy(id = "SysRole55555")
    private WebElement RoleRodioBtn1;
    ...
    public SystemAdminCreation_pg userType(String sysAdmin) throws InterruptedException {
        Thread.sleep(2000);
        selectVisibleText(UserType1, sysAdmin, "User Type");
        return this;
    }
    ...
    public boolean roleIsDisplayed(){
        try{
            return RoleRodioBtn1.isDisplayed();
    ...
    public SystemAdminCreation_pg fromHour(String FHour){
        setText(FromHour,FHour,"Allowed Form Time Hour");
        return this;
    }

    public SystemAdminCreation_pg fromMin(String FMin){
        setText(FromMin,FMin,"Allowed Form Time Min");
        return this;
    }

    public SystemAdminCreation_pg toHour(String THour){
        setText(ToHour,THour,"Allowed To Time Hour");
        return this;
    }

    public SystemAdminCreation_pg toMin(String TMin){
