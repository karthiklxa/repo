 ...
 */
public class ShouldGetErrorMsgWhenNotEnteringAnyMSISDNNUmberMP_LB extends TestInit
{
    @Test
    public void enteringNullMSISDNNUmber() throws Exception {
        ExtentTest t1 = pNode.createNode("PAYPLUS-672-LB-wallet-MPesa-03", "Should Get Error Msg When Not Entering Any MSISDN NUmber");
